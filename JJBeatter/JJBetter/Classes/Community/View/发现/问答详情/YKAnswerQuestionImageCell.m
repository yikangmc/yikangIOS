...
@implementation YKAnswerQuestionImageCell
...
-(void)allViews
{
    ...
    [self.timeLabel mas_makeConstraints:^(MASConstraintMaker *make) {
        make.left.mas_equalTo(self.nameLabel.mas_right).offset(13 * WScale);
    ...
    self.contentLabel.textColor = YK646464;
...
+(CGFloat)heightForQuestionContentLabel:(NSString *)questionLabel
{
    ...
    CGRect rect = [questionLabel boundingRectWithSize:size options:NSStringDrawingUsesLineFragmentOrigin attributes:dic context:nil];
    CGFloat countH = questionLabel.length / 26 + 1;
