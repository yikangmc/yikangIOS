...
@interface YKNurseInfor ()<UIActionSheetDelegate,UIImagePickerControllerDelegate,UINavigationControllerDelegate,YKPickerViewDelegate>

@property (weak, nonatomic) IBOutlet UIImageView *headImageView; // 头像
@property (weak, nonatomic) IBOutlet UILabel *nameLabel; // 姓名
@property (weak, nonatomic) IBOutlet UILabel *hospitalLabel; // 所在医院
@property (weak, nonatomic) IBOutlet UILabel *workTypeLabel; // 工作类型
...
- (void)viewDidLoad
{
    ...
    self.navigationItem.leftBarButtonItem = [[UIBarButtonItem alloc] initWithImage:[UIImage imageNamed:@"navigation_back"] style:UIBarButtonItemStylePlain target:self action:@selector(nurseBackToUp:)];
...
// 返回
-(void)nurseBackToUp:(UIBarButtonItem *)sender
{
...
#pragma mark  ------  完成  ----------
- (IBAction)nurseFinishBtn:(id)sender
{
...
- (BOOL)checkInfomation
{
    ...
    if (self.imageData && self.nameLabel.text.length && self.hospitalLabel.text.length && self.workTypeLabel.text.length && self.addressLabel.text.length && self.goodAtLabel.text.length && ![self.workTypeLabel.text isEqualToString:@"请选择"]) {
        return YES;
    }
    return NO;
