...
@implementation YKLabelPostDetailImgCell
...
-(void)allViews
{
    ...
    [self.photoImg1 mas_makeConstraints:^(MASConstraintMaker *make) {
        make.top.mas_equalTo(self.headImageView.mas_bottom).offset(23 * WScale);
        make.left.mas_equalTo(self.contentView.mas_left).offset(15 * WScale);
        make.right.mas_equalTo(self.photoImg2.mas_left).offset(-21 * WScale / 2);
