...
#import "YKMyAnswerVC.h"  // 当前界面
#import "YKMyQuestionCell.h"


@interface YKMyAnswerVC ()<UITableViewDataSource,UITableViewDelegate>

@property (nonatomic,strong)UITableView *tableView;

@end

@implementation YKMyAnswerVC
...
- (void)viewDidLoad
{
    ...
    self.navigationItem.leftBarButtonItem = [[UIBarButtonItem alloc] initWithImage:[UIImage imageNamed:@"navigation_back"] style:UIBarButtonItemStylePlain target:self action:@selector(MyAnswerBackToUp:)];
...
#pragma mark  ----  返回  -----
-(void)MyAnswerBackToUp:(UIBarButtonItem *)sender
{
