//
//  YKHospitalRecoveryCertifiedVC.m
//  JJBetter
//
...
#import "YKHospitalRecoveryCertifiedVC.h"  // 当前界面
...
@interface YKHospitalRecoveryCertifiedVC ()<UITableViewDataSource,UITableViewDelegate,YKPickerViewDelegate>
...
@implementation YKHospitalRecoveryCertifiedVC
...
- (void)viewDidLoad
{
    ...
    self.navigationItem.leftBarButtonItem = [[UIBarButtonItem alloc] initWithImage:[UIImage imageNamed:@"navigation_back"] style:UIBarButtonItemStylePlain target:self action:@selector(HospitalRecoveryCertifiedBackToUp:)];
...
#pragma mark  ----  返回  -----
-(void)HospitalRecoveryCertifiedBackToUp:(UIBarButtonItem *)sender
{
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    if (indexPath.section == 3) {
        ...
        NSArray *titleArr2 = @[@"所在医院",@"医院地址",@"擅长方向"];
