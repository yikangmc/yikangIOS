...
@implementation YKIdentityCertifiedBCell
...
-(void)allViews
{
    ...
    [self.leftTwoChangeOneView.customBtn setBackgroundImage:[UIImage imageNamed:@"身份认证企"] forState:UIControlStateNormal];
    self.leftTwoChangeOneView.customNameLabel.text = @"我是企业主体";
    ...
    [self.rightTwoChangeOneView.customBtn setBackgroundImage:[UIImage imageNamed:@"身份认证院"] forState:UIControlStateNormal];
    self.rightTwoChangeOneView.customNameLabel.text = @"我是医院/科室主体";
